...
<?php include("../model/modal_paginacion_admin.php"); ?>
  ...
  <a href="<?php echo SERVERURL; ?>administrador/<?=$page['nombre_original']?>"></a>
  </figure>
  <?php }?>
  ...
  <div class="paginacion-admin">
    <ul>
        <a href="<?php echo SERVERURL; ?>administrador/page/<?php echo $_GET['page']-1; ?>" onclick="animated" class="waves-effect waves-light btn red <?php echo $_GET['page'] <= 1 ? 'ocultar' : '' ?>"><li>Anterior</li></a>
        <?php for ($i=0; $i < $paginasN; $i++): ?>
        <a href="<?php echo SERVERURL; ?>administrador/page/<?=$i+1 ?>" class="contador <?php echo $_GET['page']==$i+1 ? 'activo' : '' ?>"><?php echo $i+1; ?></li></a>
      <?php endfor; ?>
        <a href="<?php echo SERVERURL; ?>administrador/page/<?php echo $_GET['page']+1; ?>" class="waves-effect waves-light btn red <?php echo $_GET['page'] >= $paginasN ? 'ocultar' : '' ?>"><li>Siguiente</li></a>
      </ul>
  </div>
