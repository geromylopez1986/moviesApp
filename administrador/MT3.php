...
$sql =" SELECT * FROM temporada3_descarga WHERE id =" .$id;

$temp3 = Conexion::consultar($sql);

foreach ($temp3 as $caps) {
	// code...
}
...
<div class="container" style="background: #dd1818;">
  ...
  <div class="row" style="border: 1px solid white; background: #333;">
    <br>
    <form class="col s12" method="post" action="../model/model_MT.php?id=<?=$caps['id'];?>" enctype="multipart/form-data" id="add_pelicula">
			<div class="row">
