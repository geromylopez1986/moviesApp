...
include("../layout/header_sesionadministrador.php");
?>

<br>
<div class="contenedor bg-dark">
	<h2 class="white-text center">Paso 1 Add Pelicula</h2>
	<br>

  <div class="row">
    <br>
    <form class="col s12" method="post" action="https://thepeliculas.com/controller/guardar_pelicula" enctype="multipart/form-data" id="add_pelicula">
      <div class="row">
          ...
          <label for="nombre_add">Subtitulo:</label>
        </div>
        <div class="input-field col s12 l3">
          <i class="material-icons prefix">title</i>
        ...
        <div class="input-field col s12 l3">
          ...
          <textarea id="descripcion_add" name="actores_add" class="materialize-textarea"  ></textarea>
          <label for="descripcion_add">Actores:</label>
        </div>
        <div class="input-field col s12 l12">
      ...
      <div class="file-field col s12 l6 input-field">
          ...
          <div class="file-path-wrapper">
			...
			<div class="file-field col s12 l12 input-field">
				<div class="btn red darken-4">
					<span>Seleccionar Bar:</span>
					<input type="file" name="slide_bar"  >
				</div>
				<div class="file-path-wrapper">
					<input class="file-path validate" type="text">
				</div>
