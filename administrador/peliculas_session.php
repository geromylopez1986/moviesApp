...
<section>
  ...
  <div class="paginacion-admin">
    <a href="<?php echo SERVERURL; ?>administrador/page/<?=1 ?>" class="waves-effect waves-light btn-large">Ver Mas</a>
  </div>
</section>
  ...
  <figure class="imghvr-shutter-in-out-vert" style="margin: 5px;">
    <img class="responsive-img" src="<?php echo SERVERURL; ?>img/series/<?=$serie['imagen']?>" style="height: 310px; width: 220px;" alt="example-image">
    <figcaption style="background: rgba(0,0,0,0);">
    ...
    <a href="<?php echo SERVERURL; ?>administrador/serie/<?=$serie['nombre_original']?>"></a>
  </figure>
