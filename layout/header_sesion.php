...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo SERVERURL; ?>css/estilos.css">
	<link rel="stylesheet" href="<?php echo SERVERURL; ?>css/imagehover.min.css">
	...
	<script type="text/javascript" src="<?php echo SERVERURL; ?>js/jquery-3.4.1.js"></script>
...
<body class="black">
	...
	<div class="sidenav-trigger">
	  <ul id="slide-out" class="sidenav">
	    ...
	    <li><a href="../administrador/peliculas_session"><i class="fas fa-video"></i> Películas Modo: ( <?= $_SESSION['usuario']['tipo_usuario'] ?> )</a></li>
			<li><a href="../peliculas"><i class="fas fa-video"></i> Películas Modo: ( Desktop )</a></li>
