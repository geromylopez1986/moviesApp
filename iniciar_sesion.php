...
<title>The Peliculas / Login</title>


<div id="row" class="row">

	<div class="col l6 s4 imagen_iniciar_sesion">
		<br>
		<br>
		<br>
		<br>
		...
		<br>
		<center>
		<h5 style="text-align: center; padding: 1rem; border: 1px solid white; display: inline-block;"><a href="index" style="color: #dd1818;">Menu Principal</a></h5>
	</center>
	</div>
	<div class="row white">
    <form class="login_form col l6 s8" action="post" id="inicio_de_sesion">
      <div class="container">
    ...
    <center><img src="img/inicio/robot-cookies.gif" alt="" width="100px"></center>
      ...
      <br>
    <center>
    <a href="registrate" class="btn tooltipped waves-effect red accent-3" data-position="bottom" data-tooltip="Registrate, es gratis!">Registrate</a>
    </center>
    </form>
  </div>
</div>
